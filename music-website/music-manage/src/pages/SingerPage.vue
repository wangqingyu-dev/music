  ...
  <div class="table">
    <div class="container">
      <div class="handle-box">
        ...
        <el-button type="success"  size="mini" icon="el-icon-download" @click="exportData">导出歌手</el-button>
      </div>
...
import { setSinger, getAllSinger, updateSingerMsg, deleteSinger, exportAllSinger } from '../api/index'
...
export default {
  ...
  methods: {
    ...
    exportData () {
      ...
      exportAllSinger(params).then(response => {
        console.log('000')
    ...
    downloadFile (data) {
      ...
      link.href = url
      link.setAttribute('download', '歌手信息.xls')
