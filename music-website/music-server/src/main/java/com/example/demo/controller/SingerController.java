...
//    返回所有歌手
     ...
     * @return 数据
     */
    @RequestMapping(value = "/exportAllSinger", method = RequestMethod.GET)
    public void exportAllSinger(HttpServletResponse response){
        singerService.exportAllSinger(response);
    }
...
//    更新歌手头像
    ...
    public Object updateSingerPic(@RequestParam("file") MultipartFile avatorFile, @RequestParam("id")int id){
        ...
        String filePath = ConfigConstants.getFileDir() + ConfigConstants.getFilePath() + "img" + System.getProperty("file.separator") + "singerPic" ;
