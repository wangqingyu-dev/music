...
//    添加歌曲
    ...
    public Object addSong(HttpServletRequest req, @RequestParam("file") MultipartFile mpfile){
        ...
        String filePath = ConfigConstants.getFileDir() + ConfigConstants.getFilePath() + "song";
...
//    更新歌曲图片
    ...
    public Object updateSongPic(@RequestParam("file") MultipartFile urlFile, @RequestParam("id")int id){
        ...
        String filePath = ConfigConstants.getFileDir() + ConfigConstants.getFilePath() + "img" + System.getProperty("file.separator") + "songPic";
        File file1 = new File(filePath);
        if (!file1.exists()){
            file1.mkdir();
        }
